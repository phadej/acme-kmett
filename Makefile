project-files: cabal.7.0.4.project cabal.7.2.2.project cabal.7.4.2.project cabal.7.6.3.project cabal.7.8.4.project cabal.7.10.3.project cabal.8.0.2.project cabal.8.2.2.project cabal.8.4.3.project cabal.8.6.1.project
build: build-7.0.4 build-7.2.2 build-7.4.2 build-7.6.3 build-7.8.4 build-7.10.3 build-8.0.2 build-8.2.2 build-8.4.3 build-8.6.1
test: test-7.0.4 test-7.2.2 test-7.4.2 test-7.6.3 test-7.8.4 test-7.10.3 test-8.0.2 test-8.2.2 test-8.4.3 test-8.6.1
deps: deps.7.0.4.png deps.7.2.2.png deps.7.4.2.png deps.7.6.3.png deps.7.8.4.png deps.7.10.3.png deps.8.0.2.png deps.8.2.2.png deps.8.4.3.png deps.8.6.1.png
...
build-8.4.3: cabal.8.4.3.project
	cabal new-build --builddir=dist-newstyle-8.4.3 --project-file cabal.8.4.3.project -w ghc-8.4.3 --disable-tests --disable-benchmarks all
build-8.6.1: cabal.8.6.1.project
	cabal new-build --builddir=dist-newstyle-8.6.1 --project-file cabal.8.6.1.project -w ghc-8.6.1 --disable-tests --disable-benchmarks all
...
cabal.8.2.2.project: cabal.darkmatter
	darkmatter
cabal.8.4.3.project: cabal.darkmatter
	darkmatter
cabal.8.6.1.project: cabal.darkmatter
	darkmatter
...
deps.8.4.3.png: cabal.8.4.3.project
	cabal new-build --builddir=dist-newstyle-8.4.3 --project-file cabal.8.4.3.project -w ghc-8.4.3 --disable-tests --disable-benchmarks all --dry-run
	cabal-plan --builddir=dist-newstyle-8.4.3 --hide-builtin --hide-global dot --tred --tred-weights | dot -Tpng -odeps.8.4.3.png
deps.8.6.1.png: cabal.8.6.1.project
	cabal new-build --builddir=dist-newstyle-8.6.1 --project-file cabal.8.6.1.project -w ghc-8.6.1 --disable-tests --disable-benchmarks all --dry-run
	cabal-plan --builddir=dist-newstyle-8.6.1 --hide-builtin --hide-global dot --tred --tred-weights | dot -Tpng -odeps.8.6.1.png
...
test-8.4.3: cabal.8.4.3.project
	cabal new-build --builddir=dist-newstyle-8.4.3 --project-file cabal.8.4.3.project -w ghc-8.4.3 --enable-tests --disable-benchmarks all
	cabal new-test --builddir=dist-newstyle-8.4.3 --project-file cabal.8.4.3.project -w ghc-8.4.3 --enable-tests --disable-benchmarks all
test-8.6.1: cabal.8.6.1.project
	cabal new-build --builddir=dist-newstyle-8.6.1 --project-file cabal.8.6.1.project -w ghc-8.6.1 --enable-tests --disable-benchmarks all
	cabal new-test --builddir=dist-newstyle-8.6.1 --project-file cabal.8.6.1.project -w ghc-8.6.1 --enable-tests --disable-benchmarks all
